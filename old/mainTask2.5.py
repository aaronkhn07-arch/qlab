...
def compute (N, Nsamples): #gives the plot
    ...
    plt.figure(figsize=(8, 8))
    plt.plot(nA_vals, Savg, marker = "o", linestyle = "-", color = 'red')
    plt.plot (nA_vals, pageApp, linestyle = '-', color = 'blue')
    plt.plot (nA_vals, maxVal, linestyle = '-', color = 'yellow')
...
def computeGUE(N, Nsamples):
    ...
    plt.figure (figsize=(8, 8))
    plt.plot (Savg, marker = "o", linestyle = "-")
    plt.plot (pageApp, linestyle = '-', color = 'blue')
    plt.plot (maxVal, linestyle = '-', color = 'black')
